...
Shader "LightingBox/Terrain/Terrain 8-Layers"
{
	...
	SubShader
	{
		...
		uniform float _Displacement_7;
		uniform float _Displacement_8;
		...
		uniform float _Normal_Scale_7;
		uniform float2 _UV_7;
		uniform float _Normal_Scale_8;
		...
		uniform float _Smoothness_7;
		uniform float _Smoothness_8;
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float4 tex2DArrayNode171 = SAMPLE_TEXTURE2D_ARRAY_LOD( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_4 ),4.0), 0.0 );
			float4 tex2DArrayNode172 = SAMPLE_TEXTURE2D_ARRAY_LOD( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_5 ),5.0), 0.0 );
			float4 tex2DArrayNode173 = SAMPLE_TEXTURE2D_ARRAY_LOD( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_6 ),6.0), 0.0 );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 weightedBlend97 = ( weightedBlendVar97.x*UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_0 ),8.0) ), _Normal_Scale_1 ) + weightedBlendVar97.y*UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_1 ),9.0) ), _Normal_Scale_2 ) + weightedBlendVar97.z*UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_2 ),10.0) ), _Normal_Scale_3 ) + weightedBlendVar97.w*UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_3 ),11.0) ), _Normal_Scale_4 ) );
			...
			float3 weightedBlend159 = ( weightedBlendVar159.x*UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_4 ),12.0) ), _Normal_Scale_5 ) + weightedBlendVar159.y*UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_5 ),13.0) ), _Normal_Scale_6 ) + weightedBlendVar159.z*UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_6 ),14.0) ), _Normal_Scale_7 ) + weightedBlendVar159.w*UnpackScaleNormal( SAMPLE_TEXTURE2D_ARRAY( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_7 ),14.0) ), _Normal_Scale_8 ) );
			...
			float4 tex2DArrayNode171 = SAMPLE_TEXTURE2D_ARRAY( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_4 ),4.0) );
			float4 tex2DArrayNode172 = SAMPLE_TEXTURE2D_ARRAY( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_5 ),5.0) );
			float4 tex2DArrayNode173 = SAMPLE_TEXTURE2D_ARRAY( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_6 ),6.0) );
			float4 tex2DArrayNode174 = SAMPLE_TEXTURE2D_ARRAY( _AlbedoMaps, sampler_AlbedoMaps, float3(( uv_AlbedoMaps * _UV_7 ),7.0) );
			...
			float temp_output_209_0 = 0.0;
			float3 temp_cast_1 = (temp_output_209_0).xxx;
			o.Emission = temp_cast_1;
			o.Metallic = temp_output_209_0;
...
Node;AmplifyShaderEditor.TexturePropertyNode;3;-2005.124,-1726.299;Float;True;Property;_AlbedoMaps;AlbedoMaps;7;0;Create;True;0;0;0;False;0;False;None;None;False;white;LockedToTexture2DArray;Texture2DArray;-1;0;2;SAMPLER2DARRAY;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.Vector2Node;201;-6410.695,-2848.947;Float;False;Property;_UV_2;UV_2;24;0;Create;True;0;0;0;False;0;False;30,30;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;203;-6410.696,-3004.833;Float;False;Property;_UV_1;UV_1;21;0;Create;True;0;0;0;False;0;False;30,30;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;204;-6419.062,-3148.868;Float;False;Property;_UV_0;UV_0;18;0;Create;True;0;0;0;False;0;False;30,30;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;202;-6410.694,-2700.985;Float;False;Property;_UV_3;UV_3;27;0;Create;True;0;0;0;False;0;False;30,30;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;205;-6396.759,-2253.799;Float;False;Property;_UV_6;UV_6;23;0;Create;True;0;0;0;False;0;False;30,30;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;207;-6396.76,-2409.686;Float;False;Property;_UV_5;UV_5;20;0;Create;True;0;0;0;False;0;False;30,30;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;208;-6405.126,-2553.721;Float;False;Property;_UV_4;UV_4;17;0;Create;True;0;0;0;False;0;False;30,30;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;206;-6396.758,-2105.838;Float;False;Property;_UV_7;UV_7;25;0;Create;True;0;0;0;False;0;False;30,30;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;191;537.1483,1231.367;Float;False;Property;_Displacement_7;Displacement_7;46;0;Create;True;0;0;0;False;0;False;0;0;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;9;-5900.493,-692.1379;Inherit;True;Property;_SplatMap1;SplatMap1;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;193;538.1483,1319.367;Float;False;Property;_Displacement_8;Displacement_8;47;0;Create;True;0;0;0;False;0;False;0;0;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;194;540.1483,1144.367;Float;False;Property;_Displacement_6;Displacement_6;45;0;Create;True;0;0;0;False;0;False;0;0;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;128;535.4833,969.0829;Float;False;Property;_Displacement_4;Displacement_4;43;0;Create;True;0;0;0;False;0;False;0;0;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;114;541.3897,707.4896;Float;False;Property;_Displacement_1;Displacement_1;40;0;Create;True;0;0;0;False;0;False;0;0;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;126;538.4833,794.0829;Float;False;Property;_Displacement_2;Displacement_2;41;0;Create;True;0;0;0;False;0;False;0;0;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;127;535.4833,881.0829;Float;False;Property;_Displacement_3;Displacement_3;42;0;Create;True;0;0;0;False;0;False;0;0;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;192;543.0546,1057.773;Float;False;Property;_Displacement_5;Displacement_5;44;0;Create;True;0;0;0;False;0;False;0;0;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;110;-2750.775,-4537.538;Float;False;Property;_Normal_Scale_1;Normal_Scale_1;32;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-2745.229,-3574.727;Float;False;Property;_Normal_Scale_6;Normal_Scale_6;37;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;146;-2752.52,-3389.847;Float;False;Property;_Normal_Scale_7;Normal_Scale_7;38;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;149;-2749.653,-3187.835;Float;False;Property;_Normal_Scale_8;Normal_Scale_8;39;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;140;-2744.24,-3769.399;Float;False;Property;_Normal_Scale_5;Normal_Scale_5;36;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;131;-2747.749,-4347.972;Float;False;Property;_Normal_Scale_2;Normal_Scale_2;33;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;132;-2743.087,-4156.866;Float;False;Property;_Normal_Scale_3;Normal_Scale_3;34;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;133;-2751.162,-3969.981;Float;False;Property;_Normal_Scale_4;Normal_Scale_4;35;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-1810.119,-2825.099;Float;False;Property;_Smoothness_2;Smoothness_2;9;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;162;-1797.169,-2275.024;Float;False;Property;_Smoothness_7;Smoothness_7;14;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;71;-1817.461,-2919.253;Float;False;Property;_Smoothness_1;Smoothness_1;8;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;74;-1810.119,-2626.099;Float;False;Property;_Smoothness_4;Smoothness_4;11;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;164;-1797.169,-2180.024;Float;False;Property;_Smoothness_8;Smoothness_8;15;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;165;-1804.511,-2473.179;Float;False;Property;_Smoothness_5;Smoothness_5;12;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;163;-1797.169,-2379.025;Float;False;Property;_Smoothness_6;Smoothness_6;13;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;73;-1830.119,-2729.098;Float;False;Property;_Smoothness_3;Smoothness_3;10;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;83;-3675.567,879.4498;Float;False;Property;_Specular_Color_4;Specular_Color_4;26;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;80;-3676.735,384.4427;Float;False;Property;_Specular_Color_1;Specular_Color_1;16;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;183;-3661.585,1606.291;Float;False;Property;_Specular_Color_8;Specular_Color_8;31;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;82;-3678.567,718.4485;Float;False;Property;_Specular_Color_3;Specular_Color_3;22;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;182;-3665.243,1283.632;Float;False;Property;_Specular_Color_6;Specular_Color_6;29;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;184;-3664.585,1445.289;Float;False;Property;_Specular_Color_7;Specular_Color_7;30;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;181;-3662.67,1113.327;Float;False;Property;_Specular_Color_5;Specular_Color_5;28;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;81;-3677.567,558.4481;Float;False;Property;_Specular_Color_2;Specular_Color_2;19;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;209;1820.949,-710.1964;Inherit;False;Constant;_Float0;Float 0;44;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1995.239,-749.6547;Float;False;True;-1;6;ASEMaterialInspector;0;0;Standard;LightingBox/Terrain/Terrain 8-Layers;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;0;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;0;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;17;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;16;FLOAT4;0,0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;0;3;209;0
WireConnection;0;4;170;0
WireConnection;0;11;112;0
ASEEND*/
//CHKSM=CC344424CE38305762266D6E3EC43053CD20EEC9